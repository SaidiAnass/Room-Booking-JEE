                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="details.room?id=${room.getRoomId()}"><img src="assets/img/hotel_2.jpg" alt="Image">
                            ...
                            <div class="col-lg-2 col-md-2">
                                <div class="price_list">
                                    <div><sup>$</sup>39*<span class="normal_price_list">${room.getPrice()}</span><small>*From/Per night</small>
