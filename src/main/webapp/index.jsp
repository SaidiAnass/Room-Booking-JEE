...
<main>
    <div id="carousel-home">
        <div class="owl-carousel owl-theme">
            <div class="owl-slide cover" style="background-image: url('http://www.ansonika.com/citytours/img/slides/slide_home_3.jpg');">
            ...
            <!--/owl-slide-->
            <div class="owl-slide cover" style="background-image: url('http://www.ansonika.com/citytours/img/slides/slide_home_1.jpg');">
                <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                    <div class="container">
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-lg-6 static">
        ...
        <div class="owl-carousel owl-theme list_carousel add_bottom_30">
            ...
            <div class="item">
                <div class="hotel_container">
                    ...
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="assets/img/hotel_2.jpg" width="800" height="533" class="img-fluid" alt="image">
            ...
            <div class="item">
                <div class="hotel_container">
                    ...
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="assets/img/hotel_3.jpg" width="800" height="533" class="img-fluid" alt="image">
            ...
            <div class="item">
                <div class="hotel_container">
                    ...
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="assets/img/hotel_4.jpg" width="800" height="533" class="img-fluid" alt="image">
                            <div class="score"><span>7.5</span>Good</div>
                            <div class="short_info hotel">
                                From/Per night<span class="price"><sup>$</sup>45</span>
                            </div>
            ...
            <div class="item">
                <div class="hotel_container">
                    ...
                    <div class="img_container">
                        <a href="single_hotel.html">
                            <img src="assets/img/hotel_5.jpg" width="800" height="533" class="img-fluid" alt="image">
    ...
    <div class="white_bg">
        <div class="container margin_60">
            ...
            <div class="row feature_home_2">
                ...
                <div class="col-md-4 text-center">
                    <img src="assets/img/adventure_icon_2.svg" alt="" width="75" height="75">
            ...
            <div class="banner_2" style="background-image: url('http://www.ansonika.com/citytours/img/banner_bg_desktop.jpg')">
